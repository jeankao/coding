...
urlpatterns = [
    ...
    url(r'^work/data/add/(?P<typing>\d+)/(?P<lesson>\d+)/(?P<index>\d+)/(?P<types>\d+)/$', views.data_add),  
    url(r'^work/data/edit/(?P<typing>\d+)/(?P<lesson>\d+)/(?P<index>\d+)/(?P<types>\d+)/(?P<data_id>\d+)/$', views.data_edit),  
    url(r'^work/data/delete/(?P<typing>\d+)/(?P<lesson>\d+)/(?P<index>\d+)/(?P<data_id>\d+)/$', views.data_delete),  
